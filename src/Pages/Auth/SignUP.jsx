    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="mb-5">
          ...
          <Input type={"text"} name={"username"}  placeholder={"Enter username"} handler={handleInputChange} value={form.username} />
        </div>
        ...
        <div className="mb-5">
          ...
          <Input name={"email"} type={"email"} placeholder={"Enter your email"} handler={handleInputChange} value={form.email} />
        ...
        <div className="mb-6">
          ...
          <Input name={"password"} type={"password"} placeholder={"Enter your password"} handler={handleInputChange} value={form.password} />
